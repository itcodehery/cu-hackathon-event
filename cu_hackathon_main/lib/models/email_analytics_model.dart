...
EmailAnalyticsModel welcomeFromJson(String str) =>
    EmailAnalyticsModel.fromJson(json.decode(str));

String emailAnalyticsModelToJson(EmailAnalyticsModel data) =>
    json.encode(data.toJson());

class EmailAnalyticsModel {
  ...
  factory EmailAnalyticsModel.fromJson(Map<String, dynamic> json) =>
      EmailAnalyticsModel(
